...
namespace _01.BinaryTree
{
    ...
    public class BinaryTree<T> : IAbstractBinaryTree<T>
    {
        ...
        {
            //We traverse through the nodes in the following order: LSR
        ...
        {
            //We traverse through the nodes in the following order: LRS
            var result = new List<IAbstractBinaryTree<T>>();
        ...
        {
            //We traverse through the nodes in the following order: SLR
            var result = new List<IAbstractBinaryTree<T>>();
